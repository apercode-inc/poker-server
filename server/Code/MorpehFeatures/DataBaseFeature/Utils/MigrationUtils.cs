...
public static class MigrationUtils
{
    ...
    public static ICreateTableColumnOptionOrWithColumnSyntax ProperForeignKey(
        this ICreateTableColumnOptionOrWithColumnSyntax expression, string table, string column, Rule onUpdate,
        Rule onDelete, string name = null)
    {
    ...
    public static ICreateColumnAsTypeOrInSchemaSyntax ColumnIfNotExists(this ICreateExpressionRoot create,
        ISchemaExpressionRoot schema, string tableName, string columnName)
    {
    ...
    public static IInSchemaSyntax ColumnsIfExists(this IDeleteExpressionRoot delete, ISchemaExpressionRoot schema,
    ...
    public static IInSchemaSyntax ColumnIfExists(this IDeleteExpressionRoot delete, ISchemaExpressionRoot schema,
